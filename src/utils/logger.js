...
// constants imported
const LOGGER_OPTIONS = require('../config/logger.config').WINSTON.OPTIONS;
const LOGGER_TYPES = require('../enums/authCodes').DB_LOGGER_TYPES;
...
if (process.env.NODE_ENV === 'dev' || process.env.NODE_ENV === 'local' || process.env.NODE_ENV === 'test') {
